...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/satz-erfassen', label: { de: 'Satz erfassen', en: 'Log set' }, icon: IconBarbell, description: 'Satz in 2 Schritten erfassen: Übung wählen, Gewicht & Reps eingeben' },
  { path: '/intents/uebung-anlegen', label: { de: 'Übung anlegen', en: 'Add exercise' }, icon: IconPlus, description: 'Neue Übung schnell anlegen mit Name und Muskelgruppe' },
  // </custom:intents>
];
