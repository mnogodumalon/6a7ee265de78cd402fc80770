...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/satz-erfassen', label: { de: 'Satz erfassen', en: 'Log set' }, icon: IconBarbell, description: 'Trainingsatz in 2 Schritten erfassen: Übung wählen, dann Gewicht und Wiederholungen eingeben' },
  // </custom:intents>
];
