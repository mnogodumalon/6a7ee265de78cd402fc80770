...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/satz-erfassen', label: { de: 'Satz erfassen', en: 'Log set' }, icon: IconBarbell, description: 'Übung wählen und Satz mit Gewicht und Wiederholungen in 2 Schritten erfassen' },
  // </custom:intents>
];
