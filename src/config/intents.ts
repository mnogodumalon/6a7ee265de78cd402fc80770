...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/satz-loggen', label: { de: 'Satz loggen', en: 'Log set' }, icon: IconBarbell, description: 'Übung wählen und Satz mit Gewicht und Wiederholungen in zwei Schritten erfassen' },
  // </custom:intents>
];
