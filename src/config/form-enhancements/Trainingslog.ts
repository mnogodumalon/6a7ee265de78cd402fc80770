// Auto-generated. Per-entity form-enhancements config for "Trainingslog".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    ...
    'wiederholungen': { kind: 'literal', value: 1 },
  },
  computed: {
    '_trainings_volume': { op: 'mul', left: { kind: 'field', key: 'gewicht_kg' }, right: { kind: 'field', key: 'wiederholungen' } },
  },
};
