...
import UebungenDetailPage from '@/pages/UebungenDetailPage';
...
const IntentUebungAnlegenPage = lazy(() => import('@/pages/intents/UebungAnlegenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="uebungen/:id" element={<UebungenDetailPage />} />
                <Route path="trainingslog" element={<TrainingslogPage />} />
                <Route path="trainingslog/:id" element={<TrainingslogDetailPage />} />
                <Route path="admin" element={<AdminPage />} />
                <Route path="verwaltung/oeffentliche-seiten" element={<PublicPagesAdmin />} />
                {/* <custom:routes> */}
                <Route path="intents/satz-erfassen" element={<Suspense fallback={null}><IntentSatzErfassenPage /></Suspense>} />
                <Route path="intents/uebung-anlegen" element={<Suspense fallback={null}><IntentUebungAnlegenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
